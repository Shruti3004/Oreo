export const DataPlaces = {
  title: "Top 10 Tourist destinations in Varanasi",
  article: [
    {
      heading: "Kashivishwanath Temple",
      paragraph: [
    ...
    {
      heading: "Benaras Hindu University",
      paragraph: [
    ...
    {
      heading: "Gyanvapi mosque or Alamgir mosque",
      paragraph: [
  ...
  pageName:
    "Top 10 Tourist Destinations | Places in Varanasi, Car Hire in Varanasi",
  description:
    "Top 10 Places in Varanasi - Vinayak Travels (Taxi in Varanasi) is one of the best travel agency in Varanasi, tour operator and taxi service provider. Book your cab with us for Kashi vishwanath Temple, Dashashwamedh Ghat, Sarnath, Assi Ghat, Tulsi Manas Temple, Durga Mandir and Ramnagar Fort.",
  keyword:
    " Top 10 Tourist Places in Varanasi, Kashi Vishwanath Darshan, Taxi Booking Services, Cab Booking in Varanasi, taxi booking services in Varanasi, car hire in Varanasi, hire taxi in Varanasi, Taxi service in Varanasi, Top 10 Tourist Destinations.",
};
