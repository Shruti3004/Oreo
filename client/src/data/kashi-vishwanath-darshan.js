export const DataKashiVishwanath = {
  title: "Kashi-Vishwanath-Darshan",
  article: [
    {
      heading: "A visit to Kashivishwanath",
      paragraph: [
    ...
    {
      heading: "Importance Of Kashi Vishwanath Temple?",
      paragraph: [
  ...
  pageName:
    "Kashi Vishwanath Darshan, Taxi Booking Services, Car Hire in Varanasi",
  description:
